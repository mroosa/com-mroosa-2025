...
const toggleConsole = () => {
    siteConsole === null || siteConsole === void 0 ? void 0 : siteConsole.classList.toggle("open");
};
function submitLine() {
}
function clearLine() {
...
document.addEventListener("keypress", (e) => {
    if (e.key == "`") {
        toggleConsole();
        if (siteConsole === null || siteConsole === void 0 ? void 0 : siteConsole.classList.contains("open")) {
    ...
    if (e.key == "Enter" && (siteConsole === null || siteConsole === void 0 ? void 0 : siteConsole.classList.contains("open")) && document.activeElement == siteTerminal) {
